    ...
    <div className="App">
      <div className="left-container">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <InputField htmlForInput="city-input" type="text" icon={<FaMapMarkerAlt />} label="State or City" value={city} handleChange={handleCityChange} />
          <InputField htmlForInput="country-input" type="text" icon={<FaGlobe />} label="Country" value={country} handleChange={handleCountryChange} />
